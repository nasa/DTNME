...
class SharedTimerSystem 
        : public Singleton<SharedTimerSystem>,
          public Logger {
public:
    void schedule_at(struct timeval *when, SPtr_Timer timer);
    void schedule_in(time_t milliseconds, SPtr_Timer timer);
    void schedule_immediate(SPtr_Timer timer);
    bool cancel_timer(SPtr_Timer timer);
...
public:
    ...
    virtual void schedule_in(time_t milliseconds, SPtr_Timer sptr);
    virtual void schedule_immediate(SPtr_Timer sptr);
    virtual bool cancel_timer(SPtr_Timer sptr);
