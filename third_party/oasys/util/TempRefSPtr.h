...
#ifndef _OASYS_TEMPREF__SPTR_H_
#define _OASYS_TEMPREF__SPTR_H_
...
public:
     ...
     */
    TempRefSPtr(const char* what1, const char* what2 = "")
     ...
     */
    TempRefSPtr(std::shared_ptr<_Type> object, const char* what1, const char* what2 = "")
     ...
     * Copy constructor.
     */
    TempRefSPtr(const TempRefSPtr& other)
    {
    ...
    ~TempRefSPtr() {
        if (object_ != NULL) {
            PANIC("TempRefSPtr %s %s destructor fired but object still exists!!",
                  what1_, what2_);
        }
    }
     ...
     * Assignment operator.
     */
    TempRefSPtr& operator=(const TempRefSPtr<_Type>& other)
    {
        object_ = other.object();
        other.release();
        return *this;
     ...
     * Assignment operator.
     */
    TempRefSPtr& operator=(std::shared_ptr<_Type> object)
    {
        ASSERTF(object_ == NULL,
                "TempRefSPtr can only assign to null reference");
        object_ = object;
        return *this;
    }
     ...
     * Equality operator.
     */
    bool operator==(std::shared_ptr<_Type> o)
    {
        return (object_ == o);
    }
...
private:
     ...
     * The object pointer
     */
    mutable std::shared_ptr<_Type> object_;
