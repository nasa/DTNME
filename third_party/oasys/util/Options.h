...
/**
 * Unsigned byte option class with octal output.
 */
class Octal16Opt : public Opt {
public:
   /**
    * Basic constructor.
    *
    ...
    * @param setp    optional pointer to indicate whether or not
                     the option was set
    */
    Octal16Opt(const char* opt, u_int16_t* valp,
             const char* valdesc = "", const char* desc = "",
             bool* setp = NULL);
     ...
     * @param setp      optional pointer to indicate whether or not
                        the option was set
     */
    Octal16Opt(char shortopt, const char* longopt, u_int16_t* valp,
             const char* valdesc = "", const char* desc = "",
             bool* setp = NULL);
...
public:
    ...
    * @param setp    optional pointer to indicate whether or not
                     the option was set
    */
    Octal8Opt(const char* opt, u_int8_t* valp,
             const char* valdesc = "", const char* desc = "",
             bool* setp = NULL);
     ...
     * @param setp      optional pointer to indicate whether or not
                        the option was set
     */
    Octal8Opt(char shortopt, const char* longopt, u_int8_t* valp,
             const char* valdesc = "", const char* desc = "",
             bool* setp = NULL);
