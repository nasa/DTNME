...
public:
     ...
     */
    virtual bool drain(u_int64_t length, bool only_if_enough = false) override;

    /**
     * Syntactic sugar for drain() with only_if_enough set to true.
     */
    virtual bool try_to_drain(u_int64_t length) override;
    ...
    virtual bool is_type_standard() override {  return false; }
