...
private:
     ...
     */
    class DeadlockTimer;
    typedef std::shared_ptr<DeadlockTimer> SPtr_DeadlockTimer;

    class DeadlockTimer : public oasys::SharedTimer, public oasys::Logger {
    public:
        ...
        void set_sptr(SPtr_DeadlockTimer& sptr) { sptr_ = sptr; }
        void cancel();
    ...
    SPtr_DeadlockTimer deadlock_timer_;
};
