...
{
    switch(location) {
        case 1: return "memory";   // dz debug case BundlePayload::MEMORY: return "memory";
        case 2: return "disk";     // dz debug case BundlePayload::DISK:   return "disk";
        case 3: return "nodata";   // dz debug case BundlePayload::NODATA: return "nodata";
        default: return "";
    }
}
