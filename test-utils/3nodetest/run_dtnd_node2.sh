#!/bin/bash
#
# This script is for node2 - edit node2.cfg to define the routing for your configuration
#                                                (mainly IP addresses)
node=node2


# node2 starts 30 minutes after data flow start by default
# but you can override with a command line parameter:  run_dtnd_node2.sh <seconds>
delay=1800
