#!/bin/bash
#
# This script is for node3 - edit node3.cfg to define the routing for your configuration
#                                                (mainly IP addresses)
node=node3


# node3 starts 45 minutes after data flow start by default
# but you can override with a command line parameter:  run_dtnd_node3.sh <seconds>
delay=2700
