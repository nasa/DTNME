...
#ifndef _IMC_GROUP_PETITION_REGISTRATION_H_
#define _IMC_GROUP_PETITION_REGISTRATION_H_
...
/**
 * Internal registration that recieves all IMC Group Petition Bundles
 * (dest EID = imc:0.0)
*/
class IMCGroupPetitionRegistration : public Registration {
public:
    IMCGroupPetitionRegistration(const SPtr_EID& sptr_eid);
...
#endif /* _IMC_GROUP_PETITION_REGISTRATION_H_ */
