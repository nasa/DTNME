...
AdminRegistration::AdminRegistration()
    : Registration(ADMIN_REGID,
                   BD_MAKE_PATTERN(BundleDaemon::instance()->local_eid()->str()),
                   Registration::DEFER,
                   Registration::NEW, 0, 0)
{
    ...
    reg_list_type_str_ = "AdminReg";
}

int
AdminRegistration::deliver_bundle(Bundle* bundle, SPtr_Registration& sptr_reg)
{
    if (bundle->is_bpv6()) {
...
int
AdminRegistration::deliver_bundle_bp6(Bundle* bundle, SPtr_Registration& sptr_reg)
{
    u_char typecode;
    ...
    {
        log_info("ADMIN_MULTICAST_PETITION from %s", bundle->source()->c_str());
        break;
    }
...
int
AdminRegistration::deliver_bundle_bp7(Bundle* bundle, SPtr_Registration& sptr_reg)
{
    int status = 0;
