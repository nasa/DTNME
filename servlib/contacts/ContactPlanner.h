...
public:
     ...
     * Access Methods
     */
    std::vector<dtn::ContactPlanner::Contact_Entry> get_plan(std::string eid);
    void parse_plan(std::string filename);
    void reset_plan();
    void update_plan();

    std::vector<Contact_Entry> get_contact(std::string eid, std::string id_range);
    void add_contact(std::string eid, std::string link_name, std::string start_time, std::string duration);
    void delete_contact(std::string eid, std::string id_range);

    bool export_plan(std::string eid, std::string filename);
