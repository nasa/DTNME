...
public:
    ...
    virtual void               Send (std::string * send_data, SPtr_LTPTimer& timer, bool back) = 0;
    virtual void               Send_Low_Priority(std::string * send_data, SPtr_LTPTimer& timer) = 0;
    ...
    virtual uint64_t           Ltp_Queued_Bytes_Quota() = 0;
