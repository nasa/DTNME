...
public:
    ...
    bool      TimeToSendIt(uint64_t agg_milliseconds);
    /**
     * Milliseconds to wait before closing out the LTP session
     */
    uint64_t  MicrosRemainingToSendIt(uint64_t agg_milliseconds);
