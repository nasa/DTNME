...
public:
    ...
    size_t             block_size()      { return cfg_.block_size_; }
    u_int64_t          total_disk_size() { return total_disk_size_; }
    u_int64_t          total_size()      { return total_size_; }
    u_int64_t          max_size()        { return max_size_; }
    u_int64_t          max_disk_size()   { return max_disk_size_; }
...
#endif
    u_int64_t total_size_;               ///M Total size of the payload files in the data store
    u_int64_t max_size_;                 ///M Max size in the data store
    size_t    total_disk_size_;          ///M Total disk size of the payload files
    size_t    max_disk_size_;            ///M Max disk size in the data store
