    ...
    : TclCommand("interface") 
{
    ...
    add_to_help("options [<cla_name>]", 
                "list Convergence Layer Adapters (CLA) available for an Interface or valid options for a specified CLA\n");
...
InterfaceCommand::exec(int argc, const char** argv, Tcl_Interp* interp)
{
    ...
    else if (strcmp(argv[1], "options") == 0) 
    {
        ...
        append_resultf("Available Convergence Layer Adapters for Interfaces:\n");
