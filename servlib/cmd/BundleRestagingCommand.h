...
protected:
    ...
    virtual int process_committed(int argc, const char** argv);
    ...
    virtual int process_internal_high_watermark(int argc, const char** argv);
    virtual int process_internal_low_watermark(int argc, const char** argv);
    virtual int process_external_high_watermark(int argc, const char** argv);
    virtual int process_external_low_watermark(int argc, const char** argv);
