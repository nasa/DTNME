...
//     BP7_UNEXPECTED_EOF (1) = need more data to parse
int64_t
BP7_BundleAgeBlockProcessor::decode_cbor(BlockInfo* block, uint8_t*  buf, size_t buflen)
{
    CborError err;
    CborParser parser;
...
//
int64_t
BP7_BundleAgeBlockProcessor::encode_cbor(uint8_t* buf, uint64_t buflen, const BlockInfo* block, const Bundle* bundle,
