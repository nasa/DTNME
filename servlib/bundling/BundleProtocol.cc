...
//----------------------------------------------------------------------
size_t
BundleProtocol::total_length(Bundle* bundle, const SPtr_BlockInfoVec& blocks)
{
    if (bundle->is_bpv6())
    {
...
//----------------------------------------------------------------------
size_t
BundleProtocol::payload_offset(const Bundle* bundle, const SPtr_BlockInfoVec& blocks)
{
    if (bundle->is_bpv6())
    {
...
//----------------------------------------------------------------------
size_t
BundleProtocol::produce(const Bundle* bundle, const SPtr_BlockInfoVec& blocks,
