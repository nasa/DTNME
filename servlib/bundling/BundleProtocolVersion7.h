...
public:
    ...
    typedef enum : uint16_t {
        ...
        IMC_DESTINATIONS_BLOCK      = 0x00C3, ///< 195 Experimental - For compatibility with ION 4.1.1 implementation
        ...
        BP7_CBOR_BLOCK_ARRAY_NO_CRC   = 0x0085, ///< INTERNAL ONLY -- NOT IN SPEC
        BP7_CBOR_BLOCK_ARRAY_WITH_CRC = 0x0086, ///< INTERNAL ONLY -- NOT IN SPEC
     ...
     */
    static bool get_admin_typexx(const Bundle* bundle,
