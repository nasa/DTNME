...
BP6_ExtendedClassOfServiceBlockProcessor::BP6_ExtendedClassOfServiceBlockProcessor()
    : BP6_BlockProcessor(BundleProtocolVersion6::EXTENDED_CLASS_OF_SERVICE_BLOCK) 
{
}
...
// BSP?)
int
BP6_ExtendedClassOfServiceBlockProcessor::prepare(const Bundle*    bundle,
...
//
int
BP6_ExtendedClassOfServiceBlockProcessor::generate(const Bundle*  bundle,
                            BlockInfoVec*  xmit_blocks,
                            BlockInfo*     block,
                            const LinkRef& link,
                            bool           last)
...
ssize_t
BP6_ExtendedClassOfServiceBlockProcessor::consume(Bundle*    bundle,
                           BlockInfo* block,
                           u_char*    buf,
                           size_t     len)
{
...
//----------------------------------------------------------------------
int
BP6_ExtendedClassOfServiceBlockProcessor::format(oasys::StringBuffer* buf, BlockInfo *b)
{
	(void) b;
