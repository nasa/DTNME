...
#ifndef _BP6_BUNDLE_STATUS_REPORT_H_
#define _BP6_BUNDLE_STATUS_REPORT_H_
...
public:
    ...
    static void create_status_report(Bundle*           bundle,
                                     ...
                                     BundleStatusReport::flag_t  status_flag,
                                     reason_t          reason);
...
#endif /* _BP6_BUNDLE_STATUS_REPORT_H_ */
