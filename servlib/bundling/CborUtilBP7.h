...
public:
    ...
    virtual int encode_eid_dtn(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid);
    virtual int encode_eid_ipn(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid);
    virtual int encode_eid_imc(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid);
    virtual int encode_eid(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid);
    virtual int encode_bundle_timestamp(CborEncoder& blockArrayEncoder, const BundleTimestamp& bts);

    virtual int decode_eid(CborValue& cvElement, SPtr_EID& sptr_eid);
