...
//----------------------------------------------------------------------
ssize_t
BP6_BlockProcessor::consume_preamble(SPtr_BlockInfoVec& recv_blocks,
...
//----------------------------------------------------------------------
void
BP6_BlockProcessor::generate_preamble(SPtr_BlockInfoVec& xmit_blocks,
                                  SPtr_BlockInfo&    block,
                                  u_int8_t      type,
                                  u_int64_t     flags,
...
//----------------------------------------------------------------------
void
BP6_BlockProcessor::init_block(SPtr_BlockInfo&    block,
                           SPtr_BlockInfoVec& block_list,
                           Bundle*       bundle,
                           u_int8_t      type,
                           u_int8_t      flags,
