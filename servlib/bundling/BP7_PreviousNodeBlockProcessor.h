...
#ifndef _BP7_PREVIOUS_NODE_BLOCK_PROCESSOR_H_
#define _BP7_PREVIOUS_NODE_BLOCK_PROCESSOR_H_
 ...
 */
class BP7_PreviousNodeBlockProcessor : public BP7_BlockProcessor {
public:
    /// Constructor
    BP7_PreviousNodeBlockProcessor();
...
protected:
    ...
    int64_t encode_block_data(uint8_t* buf, uint64_t buflen, const EndpointID& eidref, 
                              const Bundle* bundle, int64_t& encoded_len);
    int64_t encode_cbor(uint8_t* buf, uint64_t buflen, const SPtr_BlockInfo& block, const Bundle* bundle,
...
#endif /* _BP7_PREVIOUS_NODE_BLOCK_PROCESSOR_H_ */
