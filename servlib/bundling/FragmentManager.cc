...
FragmentManager::create_fragment(Bundle* bundle,
                                 const SPtr_BlockInfoVec& blocks,
                                 const SPtr_BlockInfoVec& xmit_blocks,
                                 size_t offset,
                                 size_t length,
                                 bool first,
                                 bool last)
                                      ...
                                      size_t max_length)
{
    ...
    do {
        ...
        fragment = create_fragment(bundle, bundle->recv_blocks(), xmit_blocks, offset, max_length, first, last);
        ASSERT(fragment);
