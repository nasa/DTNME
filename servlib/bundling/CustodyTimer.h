...
public:
    ...
    virtual std::string link_name() { return link_name_; }
protected:

    ///< The bundle for whom the the timer refers
    BundleRef bref_;

    LinkRef lref_;                ///< The link that it was transmitted on
    std::string link_name_;       ///< Name of the link it was transferred on

    oasys::SPtr_Timer sptr_;      ///< internal reference to this timer prevents untimely deletion
