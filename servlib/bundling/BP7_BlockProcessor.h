...
public:
    typedef enum : size_t {
        BP7_SCHEMA_TYPE_DTN = 1,
        BP7_SCHEMA_TYPE_IPN = 2,
        BP7_SCHEMA_TYPE_IMC = 3,
    } bp7_scheme_types_;
    ...
    static int64_t uint64_encoding_len(size_t val);
...
protected:
    ...
    //
    virtual int64_t encode_canonical_block(uint8_t* buf, size_t buflen, 
    ...
    virtual int encode_eid_dtn(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid, const Bundle* bundle, std::string& fld_name);
    virtual int encode_eid_ipn(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid, const Bundle* bundle, std::string& fld_name);
    virtual int encode_eid_imc(CborEncoder& blockArrayEncoder, const SPtr_EID& sptr_eid, const Bundle* bundle, std::string& fld_name);
    virtual int encode_eid(CborEncoder& blockArrayEncoder, const SPtr_EID sptr_eid, const Bundle* bundle, std::string& fld_name);
     ...
     */
    virtual bool  data_available_to_parse(CborValue& cvElement, size_t len);
    ...
    /**
     * Generic routine to decode a CBOR canonical block structure
     */
    virtual int64_t decode_canonical_block(BlockInfo* block, uint8_t*  buf, size_t buflen);
    ...
    virtual int decode_length_of_fixed_string(CborValue& cvElement, size_t& ret_val, 
                                              std::string& fld_name, size_t& decoded_byes);

    virtual int decode_boolean(CborValue& cvElement, bool& ret_val, std::string& fld_name);
    ...
    virtual int decode_uint(CborValue& cvElement, size_t& ret_val, std::string& fld_name);
    virtual int decode_eid(CborValue& cvElement, SPtr_EID& eid, std::string& fld_name);
    virtual int decode_crc_and_validate(CborValue& cvElement, size_t crc_type, 
