...
public:
    ...
    int64_t           time_to_expiration_secs(); ///< -1 if expired else seconds to expiration
    int64_t           time_to_expiration_millis(); ///< -1 if expired else milliseconds to expiration
...
//dzdebug    const SPtr_BlockInfoVec&    api_blocks_c()   const { return api_blocks_; }
//dzdebug    const SPtr_BlockInfoVec&    api_blocks_r()   const { return api_blocks_; }
...
//dzdebug    SPtr_ExpirationTimer& expiration_timer(){ return expiration_timer_; }
...
//dzdebug    void set_expiration_timer(SPtr_ExpirationTimer& e) { expiration_timer_ = e; }
//dzdebug    void clear_expiration_timer() { expiration_timer_ = nullptr; }
