...
public:
     ...
     */
    static const uint16_t LTPUDPCL_DEFAULT_PORT = 1113;
...
protected:
    ...
    private:
        ...
        SPtr_mutex               sptr_eventq_lock_;
        SPtr_condition_variable  sptr_cond_var_eventq_;

        typedef std::unique_ptr<meutils::MsgQueueX< MySendObject * >> QPtr_MsgQueueX;
        QPtr_MsgQueueX qptr_admin_eventq_;
        QPtr_MsgQueueX qptr_ds_high_eventq_;
        QPtr_MsgQueueX qptr_ds_low_eventq_;
