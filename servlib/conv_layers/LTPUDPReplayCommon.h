...
#ifndef _LTPUDP_REPLAY_COMMON_H_
#define _LTPUDP_REPLAY_COMMON_H_
...
typedef std::shared_ptr<InactivityTimer> SPtr_InactivityTimer;
...
public:
    ...
    virtual void      Post_Timer_To_Process(SPtr_InactivityTimer event) = 0;
};
//
...
//
     ...
     */
    class InactivityTimer : public oasys::SharedTimer,
                            public oasys::Logger 
    {
    public:
        ...
        void set_sptr(SPtr_InactivityTimer sptr) { sptr_ = sptr; }
        void start();
        bool cancel();
...
public:
    ...
    typedef std::shared_ptr<RetransmitTimer> SPtr_RetransmitTimer;

    class RetransmitTimer : public oasys::SharedTimer,
                            public oasys::Logger 
    {
    public:
        ...
        void set_sptr(oasys::SPtr_Timer sptr) { sptr_ = sptr; }
        void start();
    ...
    void Create_RS_Timer();
    void Create_Retransmission_Timer();
    void Start_Retransmission_Timer();
    void Cancel_Retransmission_Timer();

    SPtr_RetransmitTimer timer_;
...
public:
    ...
    //void      Clear_Timer(oasys::SPtr_Timer triggered_timer);
...
protected:
     ...
     */
    SPtr_InactivityTimer inactivity_timer_;  
