...
public:
    ...
    public:
        ...
        size_t      max_quota_overage_ = 1000000;   ///< Maximum allowed quota overage to allow
        ...
        bool        use_monospace_in_email_ = false; ///< Whether to use monospace font in email notifications (not currently used)

        size_t      min_vol_available_ = 100000000; ///< Minimum volume space needed to declare state ONLINE vs FULL
    ...
    static oasys::SpinLock scandir_lock_;
...
protected:
    ...
    public:
         ...
         * Constructor.
         */
        ExternalStorageController(const ContactRef& contact, const std::string& link_name);
       ...
       virtual void send_email_notifications(std::string& message, std::string& message2) override;
    ...
    protected:
        ...
        protected:
            bool query_okay_to_reload(const BundleFileDesc* bfd_ptr, SPtr_EID& sptr_new_dest_eid);
        ...
        {
        public:
            Emailer (std::string& message, std::string& message2,
            ...
            void run();
        protected:
            /// prevent multiple CLs writing to the sendmail pipe at the same time
            static oasys::SpinLock sendmail_pipe_lock_;

            std::string message_;
            std::string message2_;
            SPtr_EmailNotifications sptr_emails_;
            bool use_monospace_in_email_;
        };
    ...
    protected:
         ...
         */
        bool update_volume_usage_statitics();

        /**
         * Update the online state based on disk usage and quota usage
         */
        void update_volume_online_state();
        ...
        void eid_to_tokens(const SPtr_EID& eid, std::string& scheme, std::string& nodename, std::string& service);
        ...
        void load_bfd_eid_src_data(BundleFileDesc* bfd_ptr, const SPtr_EID& eid);
        void load_bfd_eid_dst_data(BundleFileDesc* bfd_ptr, const SPtr_EID& eid);
    ...
    protected:
        ...
        bool storage_tidy_ = false;                 ///< whether to delete restaged bundles while initializing
