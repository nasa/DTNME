...
//----------------------------------------------------------------------
Ciphersuite_PC11::Ciphersuite_PC11()
{
}

//----------------------------------------------------------------------
u_int16_t
Ciphersuite_PC11::cs_num(void)
{
    return CSNUM_PC;
}

//----------------------------------------------------------------------
int Ciphersuite_PC11::decrypt(
							  ...
							  LocalBuffer&   result)	    // decrypted BEK will go here
{
    ...
    if(0 != ECDH::decrypt(result, priv_key_file.c_str(), enc_data)) {
        log_err_p(log, "Ciphersuite_PC11::decrypt: decryption failed");
        return -1;
    } else {
        log_debug_p(log, "Ciphersuite_PC11::decrypt: decryption succeeded");
    }
