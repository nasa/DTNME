...
#ifndef _CIPHERSUITE_BA5_H_
#define _CIPHERSUITE_BA5_H_
 ...
 */
class Ciphersuite_BA5 : public Ciphersuite_BA {
public:
    const static int CSNUM_BA = 5;
    virtual u_int16_t cs_num() {
        return CSNUM_BA;
    };

    const static int RESULT_LEN = 32;
