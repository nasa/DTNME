...
#ifndef __CIPHERSUITE_PC7_H__
#define __CIPHERSUITE_PC7_H__
...
class Ciphersuite_PC7 : public Ciphersuite_PC {
    public:
      Ciphersuite_PC7();
      ...
      const static int CSNUM_PC  = 7;

      const static int SEC_LEVEL = 128;
