...
#ifndef _TUNNEL_ME_H_
#define _TUNNEL_ME_H_
 ...
 */
class Tunnel_Me : public oasys::App,
                  public oasys::Singleton<Tunnel_Me>
{
public:
    /// Constructor
    Tunnel_Me();
...
protected:
    ...
    typedef std::map<Tunnel_Me::CIDR, char*> NetworkEidTable;
