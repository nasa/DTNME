...
//----------------------------------------------------------------------
UDPTunnel::UDPTunnel()
    : IPTunnel("UDPTunnel", "/tunnel_me/udp"),
...
UDPTunnel::Connection::Connection(UDPTunnel* t, dtn_endpoint_id_t* dest_eid,
    ...
    : Thread("UDPTunnel::Connection", Thread::DELETE_ON_EXIT),
      Logger("UDPTunnel::Connection", "/tunnel_me/udp/conn"),
      udptun_(t),
      sock_("/tunnel_me/udp/conn/sock"),
      queue_("/tunnel_me/udp/conn"),
      next_seqno_(0),
...
UDPTunnel::Listener::Listener(UDPTunnel* t,
    ...
    : Thread("UDPTunnel::Listener", DELETE_ON_EXIT),
      Logger("UDPTunnel::Listener", "/tunnel_me/udp/listener"), 
      sock_("/tunnel_me/udp/listener/sock"),
      tsock_("/tunnel_me/udp/listener/tsock"),
      udptun_(t),
